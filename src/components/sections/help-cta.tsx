...
const defaultSteps: Step[] = [
  {
    ...
    number: "1",
    title: "Send a Photo",
    description: "Snap a pic of your space and send it to us — text, email, or through our site.",
  },
  {
    icon: MessageSquare,
    number: "2",
    title: "We'll Assess",
    description: "We\u2019ll evaluate the surface condition and recommend the right system for your needs.",
  },
  {
    icon: FileText,
    number: "3",
...
export function HelpCta({
  ...
  description = "Send us a photo of your space and we\u2019ll handle the rest.",
