...
const steps = [
  {
    ...
    description: "Snap a picture of your outdoor area and text or email it to us.",
  },
  {
    icon: MessageSquareText,
    number: "2",
    title: "We'll Recommend",
    description: "Our team reviews your space and suggests the best system for your needs.",
  },
  {
    icon: ClipboardCheck,
    number: "3",
...
export function ExteriorHelpCta() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-4">
            ...
            <p className="mt-3 text-gray-500 text-base sm:text-lg leading-relaxed">
              No pressure, no jargon. Tell us about your outdoor space and we&apos;ll match you with the right solution.
            </p>
            <Link
              href="/contact"
