...
import { Camera, MessageSquareText, ClipboardCheck, ArrowRight } from "lucide-react"
...
const steps = [
  {
    ...
    number: "1",
    title: "Send a Photo",
    description: "Snap a pic of your garage, shop, or commercial space and send it to us.",
  },
  {
    icon: MessageSquareText,
    number: "2",
    title: "Get Recommendation",
    description: "We\u2019ll review your space and suggest the best ProFlake blend and color for your needs.",
  },
  {
    icon: ClipboardCheck,
    number: "3",
...
export function ProFlakeHelpCta() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-4">
            ...
            <h2 className="mt-3 font-heading font-bold text-2xl sm:text-3xl md:text-4xl text-gray-900 tracking-tight">
              Let&apos;s Design Your ProFlake Floor
            </h2>
            <p className="mt-3 text-gray-500 text-base sm:text-lg leading-relaxed">
              Not sure which blend or color is right? It starts with a quick conversation.
            </p>
            <Link
              href="/contact"
