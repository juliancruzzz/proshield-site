...
import { Layers, Droplets, Zap, Home } from "lucide-react"

const stats = [
  { icon: Layers, value: "LVP/SPC", label: "WPC & Engineered" },
  { icon: Droplets, value: "Waterproof", label: "Rigid-Core Options" },
  { icon: Zap, value: "Click-Lock", label: "Fast Installation" },
  { icon: Home, value: "Any Room", label: "Over Concrete & More" },
]
