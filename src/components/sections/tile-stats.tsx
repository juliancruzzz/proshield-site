...
import { Grid3X3, Droplets, Ruler, Shield } from "lucide-react"

const stats = [
  { icon: Grid3X3, value: "Porcelain", label: "Ceramic & Natural Stone" },
  { icon: Droplets, value: "Waterproof", label: "With Epoxy Grout Option" },
  { icon: Ruler, value: "Large Format", label: "24×24 and Up" },
  { icon: Shield, value: "Lifetime", label: "Durable Installation" },
]
