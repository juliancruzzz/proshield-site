  ...
  return (
    <>
      ...
      <motion.button
        ...
        style={{
          background: "linear-gradient(135deg, #F7941D 0%, #D07A0A 100%)",
          boxShadow: "0 4px 20px rgba(247,148,29,0.4), 0 2px 8px rgba(0,0,0,0.2)",
        }}
      ...
      >
        ...
        {/* Badge — placed outside button via portal-like positioning to avoid
            aria-label / visible-text-label mismatch (a11y: label-content-name-mismatch) */}
        {showBadge && !isOpen && (
          <span aria-hidden="true" className="absolute -top-0.5 -right-0.5 flex h-5 w-5 items-center justify-center rounded-full bg-red-500 text-[11px] font-bold text-white ring-2 ring-white animate-pulse pointer-events-none">
            1
          </span>
        )}
      </motion.button>
        ...
        {isOpen && (
          <motion.div
            ...
            style={{
              ...
              background: "#0e1826",
              borderColor: "#1a2c48",
              boxShadow: "0 20px 60px rgba(0,0,0,0.5), 0 0 0 1px rgba(247,148,29,0.08)",
            }}
          >
            {/* Header */}
            <div
            ...
            >
              <div
                ...
                style={{ background: "linear-gradient(135deg, #F7941D, #D98315)" }}
              >
                PS
              </div>
              <div className="min-w-0">
                <h3 className="text-[15px] font-bold text-gray-50 tracking-wide">ProShield Assistant</h3>
                <p className="flex items-center gap-1.5 text-xs mt-0.5" style={{ color: "#F7941D" }}>
            ...
            >
                ...
                <motion.div
                  ...
                  style={
                    msg.role === "bot"
                      ...
                      : { background: "linear-gradient(135deg, #F7941D, #D98315)" }
                  }
                ...
                >
                  {chips.map((chip) => (
                    <button
                      ...
                      onMouseEnter={(e) => (e.currentTarget.style.background = "rgba(247,148,29,0.12)")}
              ...
              {showForm && !leadCollected && (
                <motion.form
                  ...
                  style={{ background: "#111c2e", border: "1px solid #1a2c48" }}
                >
                  <h4 className="text-sm font-semibold mb-1" style={{ color: "#F7941D" }}>
                  ...
                  <button
                    ...
                    style={{
                      background: "linear-gradient(135deg, #F7941D, #D98315)",
                      boxShadow: "0 2px 10px rgba(247,148,29,0.25)",
                    }}
                  >
